<template>
  <div class="q-pa-md flex column g-xl">
    <div class="text-h6 text-primary">
      Введите оценку альтернативы a2 по критериям с помощью треугольных чисел
    </div>
    <q-table
      flat
      bordered
    ...
    <div class="text-h6 text-primary" v-if="currentStep !== 0">
      Введите нечеткую оценку альтернативы a2
    </div>
    <q-table
      v-if="currentStep !== 0"
      flat
    ...
    <div class="text-h6 text-primary flex column g-m" v-if="currentStep >= 3">
      <div>
        {{
          `a2: Y = ${answers3.k}x ${answers3.b > 0 ? '+' : ' '} ${answers3.b}`
        }}
      </div>
      <q-input
...
onMounted(() => {
  const localCurrentStep = localStorage.getItem('current-step-4');

  if (localCurrentStep) {
    currentStep.value = parseInt(localCurrentStep);
  }

  const localAnswers0 = localStorage.getItem('user-answers-4-0');
  const localFinalAnswers0 = localStorage.getItem('answer-4-0');
  ...
  const localAnswers1 = localStorage.getItem('user-answers-4-1');
  const localFinalAnswers1 = localStorage.getItem('answer-4-1');
  ...
  const localAnswers2 = localStorage.getItem('user-answers-4-2');
  const localFinalAnswers2 = localStorage.getItem('answer-4-2');
  ...
  const localAnswers3 = localStorage.getItem('user-answers-4-3');
  const localFinalAnswers3 = localStorage.getItem('answer-4-3');
  ...
  const localAnswers4 = localStorage.getItem('user-answers-4-4');
  const localFinalAnswers4 = localStorage.getItem('answer-4-4');
...
watch(
  answers0,
  () => {
    localStorage.setItem('user-answers-4-0', JSON.stringify(answers0.value));
  },
  { deep: true }
);
...
watch(
  currentStep,
  () => {
    localStorage.setItem('current-step-4', JSON.stringify(currentStep.value));
  },
  { deep: true }
);
...
watch(
  finalAnswers0.value,
  () => {
    localStorage.setItem('answer-4-0', JSON.stringify(finalAnswers0.value));
  },
  { deep: true }
);
...
watch(
  answers1,
  () => {
    localStorage.setItem('user-answers-4-1', JSON.stringify(answers1.value));
  },
  { deep: true }
);
...
watch(
  finalAnswers1.value,
  () => {
    localStorage.setItem('answer-4-1', JSON.stringify(finalAnswers1.value));
  },
  { deep: true }
);
...
watch(
  answers2,
  () => {
    localStorage.setItem('user-answers-4-2', JSON.stringify(answers2.value));
  },
  { deep: true }
);
...
watch(
  finalAnswers2,
  () => {
    localStorage.setItem('answer-4-2', JSON.stringify(finalAnswers2.value));
  },
  { deep: true }
);
...
watch(
  answers3,
  () => {
    localStorage.setItem('user-answers-4-3', JSON.stringify(answers3.value));
  },
  { deep: true }
);
...
watch(
  finalAnswers3,
  () => {
    localStorage.setItem('answer-4-3', JSON.stringify(finalAnswers3.value));
  },
  { deep: true }
);
...
watch(
  answers4,
  () => {
    localStorage.setItem('user-answers-4-4', JSON.stringify(answers4.value));
  },
  { deep: true }
);
...
watch(
  finalAnswers4,
  () => {
    localStorage.setItem('answer-4-4', JSON.stringify(finalAnswers4.value));
  },
  { deep: true }
);
